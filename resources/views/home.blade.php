      ...
      <div class="ui centered stackable grid">
        ...
        <div class="row">
          <div class="nine wide column">
            ...
            <div class="ui  statistics" id="numbers_1">
              <div class="statistic">
                <div class="value">
                  <i class="idea icon"></i> {{count($projets)}}
                </div>
                <div class="label">
                  Projets
                </div>
              ...
              <div class="statistic">
                <div class="value">
                  <i class="handshake icon"></i> {{count($partenaires)}}
                </div>
                <div class="label">
                  Sponsors Permanents
                </div>
